function [rxdataIQ,ERR_CODE] = XSRP_RFLoopback(txdataIQ,pcip,xsrpip)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%创建UDP对象，并打开
udp_obj = udp(xsrpip,13345,'LocalHost',pcip,'LocalPort',12345,'TimeOut',1,'OutputBufferSize',61440,'InputBufferSize',61440*10);
udp_obj.Timeout=1;
fopen(udp_obj);
